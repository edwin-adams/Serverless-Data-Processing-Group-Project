...
const Dashboard = () => {
  ...
  useEffect(() => {
    ...
    const GET_mohituserdata =
      "https://rv7nzfzjhc.execute-api.ca-central-1.amazonaws.com/Prod/getScore?userId=" +
      "user_5"; // loggedUser.user_id
    ...
    for (let i = 1; i < 10; i++) {
      let GET_mohituserdata2 =
        "https://rv7nzfzjhc.execute-api.ca-central-1.amazonaws.com/Prod/getScore?userId=user_" +
        i;
